...
<%
	...
	if (request.getParameter("reportTitle") != null) reportTitle = request.getParameter("reportTitle");
	if (request.getParameter("reportContent") != null) reportContent = request.getParameter("reportContent");
	...
	String from = "rlawnsdnekt@gmail.com";
	String to = "rlawnsdnekt@gmail.com";
