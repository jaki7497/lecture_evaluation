...
%>
	...
	<section class="container">
		<form method="get" action="./index.jsp" class="form-inline mt-4">
			...
			<select name="searchType" class="form-contorl mx-1 mt-2">
			...
			<div class="card-header bg-light">
				<div class="row">
					<div class="col-8 text-left">
						<%= evaluation.getLectureName() %>&nbsp;<small><%= evaluation.getProfesseorName() %></small>
					</div>
			...
			<div class="card-body">
				...
				<div class="row">
					<div class="col-9 text-left">
						...
						만족도 <span style="color: red;"><%= evaluation.getLectureScroe() %></span>
						<span style="color: green;">(추천: <%= evaluation.getLikeCount() %>)</span>
					</div>
					<div class="col-3 text-right">
						<a onclick="return confirm('추천하시겠습니까?')"
							href="./likeAction.jsp?evaluationID=<%= evaluation.getEvaluationID() %>"><span
							style="color: blue;">추천</span></a> &nbsp;&nbsp; <a
							onclick="return confirm('삭제하시겠습니까?')"
							href="./deleteAction.jsp?evaluationID=<%= evaluation.getEvaluationID() %>"><span
				...
				<div class="modal-body">
					<form action="./evaluationRegisterAction.jsp" method="post">
						<div class="form-row">
							...
							<div class="form-group col-sm-6">
								<label>교수명</label> <input type="text" name="professeorName"
									class="form-control" maxlength="20">
							</div>
						</div>
						<div class="form-row">
							<div class="form-group col-sm-4">
								<label>수강년도</label> <select name="lectureYear"
									class="form-control">
						...
						<div class="form-row">
							...
							<div class="form-group col-sm-3">
								<label>난이도</label> <select name="comfortableScore"
									class="form-control">
									<option value="A" selected>A</option>
									<option value="B" selected>B</option>
									<option value="C" selected>C</option>
							...
							<div class="form-group col-sm-3">
								<label>만족도</label> <select name="lectureScroe"
									class="form-control">
									<option value="A" selected>A</option>
									<option value="B" selected>B</option>
									<option value="C" selected>C</option>
